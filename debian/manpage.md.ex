% valijson(SECTION) | User Commands
%
% "February 23 2024"
...
valijson - program to do something

# SYNOPSIS

**valijson** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**valijson** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **valijson** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**valijson** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    valijson. See **foo.conf**(5) for further details.
...
**valijson** provides some return codes, that can be used in scripts:
...
Minjun Kim <mjkim@woowahan.com>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 Minjun Kim
